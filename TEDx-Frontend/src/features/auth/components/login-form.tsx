      ...
      <CardContent className="px-0 sm:px-6">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <Button
            type="submit"
            disabled={isPending}
            className="w-full bg-brand-500 hover:bg-brand-600 text-white h-12 mt-6 shadow-[0_2px_10px_rgba(0,0,0,0.5),0_0_24px_rgba(235,0,40,0.35)]"
          >
            {isPending ? (
              <>
        ...
        <div className="relative my-6 text-center">
          ...
          <span className="relative px-3 bg-background sm:bg-card text-[11px] text-neutral-500 uppercase tracking-widest font-mono">
            {t("orContinueWith")}
          </span>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          <Button
            variant="outline"
            type="button"
            className="h-12 border-neutral-200 dark:border-[#2B2B38] bg-neutral-100 dark:bg-[#16161D] hover:dark:bg-[#20202A]"
          >
          ...
          >
            <svg
              className="size-4 fill-current shrink-0 mr-2"
              viewBox="0 0 170 170"
            >
